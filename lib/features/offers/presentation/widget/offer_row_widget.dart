...
class OfferRowWidget extends StatelessWidget {
  OfferRowWidget({Key? key,required this.title,required this.data,required this.hasText,required this.hasBuilding,required this.hasRate}) : super(key: key);
  String title;
  String data;
  bool hasText;
  bool hasBuilding;
        ...
        Padding(
            ...
            child: Row(
              children: [
                ...
                hasRate==true?
                Image.asset('assets/images/rate.png',width: w*0.05,):Container(),
              ],
            )
        ),
