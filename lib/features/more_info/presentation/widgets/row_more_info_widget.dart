...
class MoreInfoRowWidget extends StatelessWidget {
  MoreInfoRowWidget({Key? key,required this.title,required this.data,required this.hasText,required this.hasBuilding,this.address=false}) : super(key: key);
  String title;
  String data;
  bool hasText;
  bool hasBuilding;
