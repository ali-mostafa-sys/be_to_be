...
class RowHistoryWidget extends StatelessWidget {
  RowHistoryWidget({Key? key,required this.title,required this.data,required this.hasText,required this.hasBuilding,required this.hasLocation}) : super(key: key);
  String title;
  String data;
  bool hasText;
  bool hasBuilding;
        ...
        Padding(
            ...
            child: Row(
              children: [
                ...
                hasLocation==true?Icon(Icons.location_on_outlined,color:HexColor('#6A6A6A') ,):Container(),
              ],
            )
        ),
