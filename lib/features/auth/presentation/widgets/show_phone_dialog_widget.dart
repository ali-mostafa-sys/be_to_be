                  ...
                  child: Column(
                    ...
                    children: [
                      IntlPhoneField(
                        ...
                        onCountryChanged: (aaa){
                          countryCode=aaa.dialCode;
                          print('=+++++++++++++++++++++++++++++');
                          print(countryCode);
                          print(aaa.code);
                          print(aaa.flag);
                            ...
                            child: ButtonTextWidget(
                                ...
                                onPressed: () {
                                  if (bloc.formKey.currentState!.validate()) {
                                    String phone=bloc.phone.text.toString().substring(1,bloc.phone.text.length);

                                    String allPhone='+$countryCode$phone';
                                    bloc.phone.text=allPhone;
                                    print( bloc.phone.text);
                                    bloc.add(OnPhoneNextButtonEvent(
                                        phoneNumber:
                                            bloc.phone.text.toString()));
                                  }
                                }),
                          ),
                        ],
