...
class DropDownButtonChooseTenderWidget extends StatelessWidget {
   DropDownButtonChooseTenderWidget({Key? key,required this.items,required this.searchHint,required this.buttonText,required this.onChange}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: MultiSelectDialogField(
        ...
        searchable: true,
        title: Text(searchHint,style: TextStyle(color: primaryColor,fontSize: w*0.03)),
        buttonText:  Text(buttonText,style: TextStyle(color: primaryColor),),
        buttonIcon: Icon(Icons.keyboard_arrow_down_sharp,color: primaryColor,size: w*0.07,),
        dialogHeight: h*0.2,
        dialogWidth: w*0.4,
